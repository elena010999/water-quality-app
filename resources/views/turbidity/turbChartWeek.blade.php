...
<head>
    ...
    <title>Turbidity this Week</title>
...
<body>
        ...
        <div class="s-layout">
            ...
            <div class="container mt-4" style="padding-left:170px;">
                ...
                <ol class="breadcrumb" style="color:white;background-color:#15324f">
                        ...
                        <li class="breadcrumb-item"><a href="/turbChartWeek"  style="color:orangered"><i>This Week</i></a></li>
    ...
    <script type="text/javascript">
        ...
        var temperaturesWeek = {{Js::from($data)}};

        const data = {
            labels: labels,
            datasets: [{
                label: 'Turbidity this week',

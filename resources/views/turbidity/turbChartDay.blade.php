...
<body>
        ...
        <div class="s-layout">
            ...
            <div class="container mt-4" style="padding-left:170px;">
                ...
                <ol class="breadcrumb" style="color:white;background-color:#15324f">
                        ...
                        <li class="breadcrumb-item"><a href="/turbChart">Turbidity</a></li>
                        <li class="breadcrumb-item"  style="color:orangered"><a href="/turbChartDay"><i>Today</i></a></li>
            ...
            <canvas id="turbChartAll" height="100" width="300"></canvas>
    </x-app-layout>
    ...
    <script type="text/javascript">
        ...
        var turbiditiesToday = {{Js::from($data)}};

        const data = {
            labels: labels,
            datasets: [{
                label: 'Turbidity Today',
                backgroundColor: 'rgb(255, 69, 0)',
                borderColor: 'rgb(255, 69, 0)',
                data: turbiditiesToday,
            }]
        };
        ...
        const myChart = new Chart(
            document.getElementById('turbChartAll'),
            config
        );
    </script>
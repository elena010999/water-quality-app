...
<head>
    ...
    <title>Turbidity last 10 Days</title>
...
<body>
        ...
        <div class="s-layout">
            ...
            <div class="container mt-4" style="padding-left:170px;">
                ...
                <ol class="breadcrumb" style="color:white;background-color:#15324f">
                        ...
                        <li class="breadcrumb-item"><a href="/turbChartLast10Days" style="color:orangered"><i>Last 10 Days</i></a></li>
    ...
    <script type="text/javascript">
        ...
        var last10 = {{Js::from($data)}};

        const data = {
            labels: labels,
            datasets: [{
                label: 'Turbidity last 10 days',

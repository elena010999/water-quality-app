...
<head>
    ...
    <title>Temperature last 60 days</title>
...
<body>
        ...
        <div class="s-layout">
            ...
            <div class="container mt-4" style="padding-left:170px;">
                ...
                <ol class="breadcrumb" style="color:white;background-color:#15324f">
                        ...
                        <li class="breadcrumb-item"><a href="/tempChartLast60Days" style="color:orangered"><i>Last 60 Days</i></a></li>
                    </ol>
                </nav>
            </div>
    ...
    <script type="text/javascript">
        ...
        const data = {
            labels: labels,
            datasets: [{
                label: 'Temperature last 60 Days',
